...
Http_Connect::SERVER_ANALYSIS_RESULT Http_Connect::execute_request()
{
    ...
    strncpy(hc_absolute_file_path + website_root_length, hc_file_pathname, MAX_FILE_PATH - website_root_length); // Copy file relative path to hc_absolute_file_path buffer.
